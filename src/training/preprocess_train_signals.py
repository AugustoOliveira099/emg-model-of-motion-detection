...
## Usar apenas em NOVOS arquivos, separando esses dados em uma nova pasta
## uma vez que os arquivos existentes já possuem header, e se aplicado novamente, duplicará o header
# patient1.add_header()
# patient2.add_header()
# patient3.add_header()
